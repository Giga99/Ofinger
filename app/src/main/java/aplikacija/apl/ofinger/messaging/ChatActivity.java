package aplikacija.apl.ofinger.messaging;
...
import aplikacija.apl.ofinger.adapters.MessageAdapter;
...
import aplikacija.apl.ofinger.notifications.Data;
import aplikacija.apl.ofinger.notifications.Sender;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data( "" + ApplicationClass.currentUser.getUid(), username + ": " + message, "Nova poruka", "" + receiver, R.mipmap.logo_foreground, "message");
